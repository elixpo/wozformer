...
and checkpoints are available at the project repository (\url{https://github.com/elixpo/wozformer}); Appendix~\ref{app:walkthrough} additionally
...
repository (\url{https://github.com/elixpo/wozformer}). Appendix~\ref{app:walkthrough}
provides a hand-verifiable numerical trace on a toy instance.
