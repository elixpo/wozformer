...
from models.makes_sense_v2_1 import DeepMakesSenseBiGRUV2_1, DeepMakesSenseEvaluatorV2_1
from search import AlphaLMSearcher
from tokenizer import clean_and_tokenize

class TestDeepMakesSenseEvaluatorV2_1(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.test_dir = ROOT_DIR / "makes_sense_v2_1_test_temp"
        ...
        cls.model = DeepMakesSenseBiGRUV2_1(
            sentence_dim=100,
            gru_hidden=128,
            dropout=0.0
        )
        cls.checkpoint_path = cls.test_dir / "test_makes_sense_v2_1.pt"
    ...
    def test_model_forward(self):
        """Test Makes-Sense v2.1 model forward pass and output bounds."""
    ...
    def test_evaluator_inference(self):
        """Test Makes-Sense v2.1 evaluator wrapper initialization and scoring."""
    ...
    def test_search_integration_with_makes_sense(self):
        """Test beam search integration when Makes-Sense v2.1 trajectory scorer is active."""
        evaluator = DeepMakesSenseEvaluatorV2_1(
            model_path=self.checkpoint_path,
            w2v_path=self.w2v_path
        )
