...
def train_makes_sense():
    ...
    log_info(f"Training Recipe Makes-Sense Transformer on device: {device}")
    ...
    best_model_path = ROOT_DIR / "models" / "makes_sense_recipes_transformer.pt"
    ...
    if test_path.exists():
        ...
        print("\n--- Recipe Makes-Sense Transformer Test Metrics ---")
        ...
        with open(ROOT_DIR / "models" / "makes_sense_recipes_metrics.json", "w") as f:
