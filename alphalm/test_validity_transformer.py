...
class TestSentenceValidityTransformer(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.test_dir = ROOT_DIR / "validity_transformer_test_temp"
        ...
        cls.model = SentenceValidityTransformer(
        ...
        cls.checkpoint_path = cls.test_dir / "test_sentence_validity_transformer.pt"
    ...
    def test_model_forward(self):
        """Test validity Transformer model forward pass and output bounds."""
    ...
    def test_evaluator_inference(self):
        """Test validity Transformer evaluator wrapper initialization and scoring."""
        evaluator = SentenceValidityEvaluatorTransformer(
    ...
    def test_search_integration_with_validity(self):
        """Test beam search integration when sentence validity Transformer is active."""
        evaluator = SentenceValidityEvaluatorTransformer(
            model_path=self.checkpoint_path,
            w2v_path=self.w2v_path
        )
